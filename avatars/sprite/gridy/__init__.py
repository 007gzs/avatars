...
class GridySprite(SpriteBase):

    def sprite(self, random):
        body_bg1, body_bg2 = random.pickone(colors['bg'])
        eyes_fg1, eyes_fg2 = random.pickone(random.pickone(colors['fg']))
        mouth_fg1, mouth_fg2 = random.pickone(random.pickone(colors['fg']))
        body_path = random.pickone(paths['body'])
        ...
        svg_paths = [
            ...
            '<g style="fill: {body_bg2}" clip-path="url(#clip-b)">{body_path}</g>',
            '<g style="fill: {eyes_fg1}" clip-path="url(#clip-a)">{eyes_path}</g>',
            '<g style="fill: {eyes_fg2}" clip-path="url(#clip-b)">{eyes_path}</g>',
            '<g style="fill: {mouth_fg1}" clip-path="url(#clip-a)">{mouth_path}</g>',
            '<g style="fill: {mouth_fg2}" clip-path="url(#clip-b)">{mouth_path}</g>',
            '</svg>'
        ]
        svg = ''.join(svg_paths)
